    ...
    return (
        <div className='w-full min-h-screen bg-gray-100'>
            <div className='cursor-text shadow-[0px_0px_55px_-50px_#000000] w-full py-1 h-18 md:h-24 mt-22 flex items-center gap-14 md:gap-0 border-y border-gray-400 bg-white'>
                ...
                <span className='text-center md:text-right pr-[26%] font-mono self-center w-[52%]  md:w-[82%] text-2xl md:text-4xl font-semibold'>Manage - Addresses</span>
                <button className='hover:font-bold hover:scale-98 hover:text-shadow-md transition-all ease-in-out duration-150 hover:inset-shadow-[inset_0px_0px_12px_0px_rgba(0,0,0,0.2)] md:flex hidden gap-2 px-6 items-center justify-center py-3 rounded-lg text-lg bg-trust text-white'>
