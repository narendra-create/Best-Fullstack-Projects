...
const Login = () => {
    ...
    return (
        <div className='w-full h-screen mt-40'>
            ...
            <div className='fixed h-[130vh] -z-10 top-0 w-full'> <div className='bg-black h-full w-full absolute'></div><img src='/vendorbg.jpg' alt="Background image" className='-z-20 h-full w-full opacity-80 blur-xs object-cover' /></div>
