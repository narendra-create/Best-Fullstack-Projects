            ...
            <div className='w-full px-10 mx-auto h-24 flex justify-between items-center'>
                ...
                <div className='flex gap-16 items-center justify-center'>
                    <Link href={'/VendorTools/Dashboard'}>
                        <div className='text-xl border-2 border-white py-2 px-6 transition-all ease-in-out duration-200 cursor-pointer hover:scale-101 hover:bg-hero-bg hover:text-black rounded-2xl mt-2 font-mono'>DashBoard</div>
                    </Link>
