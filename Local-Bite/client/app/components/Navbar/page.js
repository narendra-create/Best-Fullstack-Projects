...
const Navbar = () => {
    ...
    const isDashboard = pathname === '/VendorTools/Addproducts'
            ...
            <div className='w-full px-10 mx-auto h-24 flex justify-between items-center'>
                ...
                <div className='flex gap-16 items-center justify-center'>
                    <Link href={'/VendorTools/Dashboard'}>
                        <div className={`${dashboardcolor} text-xl border-2 py-2 px-6 transition-all ease-in-out duration-200 cursor-pointer hover:scale-101 rounded-2xl mt-2 font-mono`}>DashBoard</div>
                    </Link>
