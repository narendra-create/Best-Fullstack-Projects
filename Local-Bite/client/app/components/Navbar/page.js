...
const Navbar = () => {
    ...
    const bgcolor = isDarkpage || isLoginpage ? "white" : "black"
    ...
    return (
        <nav className='w-full h-24'>
            <div className='w-full px-10 mx-auto h-24 flex justify-between items-center'>
                ...
                {!isLoginpage ? <Link href={'/components/Login'} id='Existinguser'><button>Already Registered ?</button></Link> : <Link href={'/components/Register'} id='newuser'><button>New user ?</button></Link>}
