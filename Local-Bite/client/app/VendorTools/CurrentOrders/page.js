        ...
        <section className='w-full mt-34 text-black h-full flex flex-col gap-10'>
            ...
            <div className='flex flex-col'>
                <div className='md:pl-10'>
                    <h2 className='text-3xl md:text-4xl font-semibold mb-2 md:w-417 md:mx-auto text-center bg-gray-100 py-3'>New Orders</h2>
                    <div className='h-full md:mx-auto md:w-[78%]  md:grid md:gap-y-0 md:gap-x-4 md:grid-cols-3 flex flex-col gap-5 items-center justify-center'>
                ...
                <div className='md:pl-10 md:mt-5 mx-auto w-full'>
                    <h2 className='text-3xl py-4 mx-5 mt-2 rounded-md bg-gray-100 md:text-4xl font-semibold mb-8 text-center md:text-left w-[90%] md:mx-auto md:w-417'>Current Orders</h2>
                    <div className='h-full md:mx-auto md:w-[78%] md:grid md:gap-x-18 grid-cols-3 items-center flex flex-col gap-3 md:justify-center'>
